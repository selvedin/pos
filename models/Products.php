...
class Products extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['name'], 'required'],
            [['price','price1','price2', 'color', 'size', 'qnt'], 'number'],
            [['id_category', 'id_unit', 'status', 'offer'], 'integer'],
	...
	$flds = [
			...
			['fld'=>'price1', 'type'=>'text','max'=>512],
			['fld'=>'price2', 'type'=>'text','max'=>512],
			['fld'=>'code', 'type'=>'text','max'=>512],
			['fld'=>'barcode', 'type'=>'text','max'=>100],
			['fld'=>'description', 'type'=>'area','max'=>1500],
			['fld'=>'image', 'type'=>'file'],
			
		    ],
		    [
			['fld'=>'qnt', 'type'=>'text','max'=>512],
			['fld'=>'status', 'type'=>'check','vals'=>  Products::getStatus(), 'yes'=>true],
			['fld'=>'offer', 'type'=>'check','vals'=>  Products::getStatus(), 'yes'=>true],
	...
	return ['id_product', 'name', 'code', 'price','price1','price2','qnt', 'barcode', 'imageThump', 'id_category', 'status', 'offer'];
    }
	...
	return ['id_product', 'name','price', 
		['attribute'=>'id_category', 'value'=>Categories::getName($model->id_category)],
		['attribute'=>'status', 'value'=> Products::getStatus($model->status)],
		//['attribute'=>'offer', 'value'=> Products::getStatus($model->status)],
		['attribute'=>'code', 'value'=>$model->code],
		['attribute'=>'barcode', 'value'=>$model->barcode],
